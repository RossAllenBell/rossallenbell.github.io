function TicTacToe() {
    ...
    function getWinner(aBoard) {
        ...
        //rows
        if      (aBoard[0][0] === aBoard[1][0] && aBoard[0][0] === aBoard[2][0]) winner = aBoard[0][0];
        else if (aBoard[0][1] === aBoard[1][1] && aBoard[0][1] === aBoard[2][1]) winner = aBoard[0][1];
        else if (aBoard[0][2] === aBoard[1][2] && aBoard[0][2] === aBoard[2][2]) winner = aBoard[0][2];
        
        //columns
        else if (aBoard[0][0] === aBoard[0][1] && aBoard[0][0] === aBoard[0][2]) winner = aBoard[0][0];
        else if (aBoard[1][0] === aBoard[1][1] && aBoard[1][0] === aBoard[1][2]) winner = aBoard[1][0];
        else if (aBoard[2][0] === aBoard[2][1] && aBoard[2][0] === aBoard[2][2]) winner = aBoard[2][0];
        
        //diags
        else if (aBoard[0][0] === aBoard[1][1] && aBoard[0][0] === aBoard[2][2]) winner = aBoard[0][0];
        else if (aBoard[0][2] === aBoard[1][1] && aBoard[0][2] === aBoard[2][0]) winner = aBoard[0][2];
